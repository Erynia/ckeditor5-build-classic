...
```bash
npm install --save @ckeditor-custom/ckeditor5-build-classic-with-font
```
...
<script src="./node_modules/@ckeditor-custom/ckeditor5-build-classic-with-font/build/ckeditor.js"></script>
<script>
	ClassicEditor
...
```js
import ClassicEditor from '@ckeditor-custom/ckeditor5-build-classic-with-font';

// Or using the CommonJS version:
// const ClassicEditor = require( '@ckeditor-custom/ckeditor5-build-classic-with-font' );
